...
# via https://github.com/yhchen/ttc2ttf/blob/master/ttc2ttf.py
# converted tabs to spaces and linted with black and translated print statements to
# English (Louis Maddox, 2021)
...
if buf[:4] != b"ttcf":
    ...
    print("Number of included TTF files: %s" % ttf_count)
